...
class CVAEModel(gnmt_model.GNMTModel):
    ...
    for i in range(_num_encoder_layers):
      ...
      for j in range(_num_rnn_layers):
        ...
        _init_state, _prior_mu, _prior_logvar, _recog_mu, _recog_logvar = \
          self._get_decoder_init_state(_src_state, ctx_encoder_state, _tgt_state, "%s_%s"%(i,j), hparams)
  ...
  def _get_decoder_init_state(self, src_state, ctx_state, tgt_state, scope_idx, hparams):
